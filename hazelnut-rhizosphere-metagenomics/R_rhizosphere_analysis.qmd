...
beta_bracken <- get_beta(physeq_object_list_bracken, "PCoA", "bray")
...
get_bubble_plots <- function(df_list, x_axis_text_size) {
  ...
  for (i in list_names) {
    ...
    current_plot <- ggplot(current_df, aes(x = V2, y = source)) +
      ...
      scale_size_continuous(limits = c(0, 100), range = c(1, 50), breaks = c(1, 10)) +
...
colours_stacked <- distinctColorPalette(150)
...
# Execute to save phylum and gene level bubble plots as .pdf and .svg
...
#ggsave("/Users/johnrobinson/Desktop/rhizosphere_manuscript_pictures/4.pdf", plot = beta_dram_ra, width = 6, height = 7, units = "in")
#ggsave("/Users/johnrobinson/Desktop/rhizosphere_manuscript_pictures/4.svg", plot = beta_dram_ra, width = 6, height = 7, units = "in")
```
...
kruskal_test_mmseqs_subset <- get_kruskal_wallis(physeq_object_subset_list_mmseqs, "shannon")
